...
public class SableCC
{
  ...
  private static boolean amhDumping = false;
  ...
  private static final String OPT_AMH_DUMP = "--amh-dump";
  ...
  private static void displayCopyright()
  {
    ...
    System.out.println();
    System.out.println("This version includes changes made at Amherst College by Lyle A. McGeoch,");
    System.out.println("2008, 2009, and 2010.  For information on changes, see the file AMHERST");
    System.out.println("in the distribution directory.");
    System.out.println();
...

    {
      ...
      while(arg < arguments.length)
      {
        ...
        */
        ...
        else if(arguments[arg].equals(OPT_AMH_DUMP))
        {
          amhDumping = true;
        }
        else
